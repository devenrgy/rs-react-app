...
export const FavoritesPopup = ({ items, className, handleClearAll, handleDownload }: Props) => {
	return (
		<div className={cn('relative w-full max-w-[320px] md:max-w-md', className)}>
			<div className='overflow-hidden rounded-3xl shadow-lg'>
				<div className='dark:bg-highlight-low max-h-90 md:max-h-150 grid flex-auto grid-rows-[1fr_min-content] overflow-hidden rounded-3xl bg-white text-sm/6 shadow-lg ring-1 ring-gray-900/5'>
					...
					<div className='dark:bg-highlight-high dark:text-text'>
						<p className='dark:bg-highlight-low bg-rose p-1 text-center'>
							{items.length} {items.length === 1 ? 'item is' : 'items are'} selected
						</p>
