...
export const FavoritesPopup = ({ items, className, handleClearAll, handleDownload }: Props) => {
	return (
		<div className={cn('w-full max-w-[320px] overflow-clip rounded-3xl md:max-w-sm', className)}>
			<div className='dark:bg-highlight-low max-h-90 grid grid-rows-[1fr_min-content_min-content] rounded-3xl bg-white text-sm/6 shadow-lg ring-1 ring-gray-900/5'>
